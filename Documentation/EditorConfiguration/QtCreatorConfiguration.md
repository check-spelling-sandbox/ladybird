...
First, make sure you have a working toolchain and can build and run Ladybird. See [Ladybird browser build instructions](../BuildInstructionsLadybird.md) for instructions for setting that up.
