...
{
    // Set channel count, fall back to default if not provided
    ...
    // Set channel count mode, fall back to default if not provided
    ...
    // Set channel interpretation, fall back to default if not provided
